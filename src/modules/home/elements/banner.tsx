  ...
  return (
   ...
   <div className='text-white  flex max-w-4xl gap-y-4 m-auto items-center justify-center flex-col  pt-32'>
         <div className='flex flex-col items-center gap-y-4'>
             <h1 className='md:text-5xl text-3xl font-bold z-50  text-center '>Stay <span className='bg-blue-700 px-2'>informed</span> with our alert tool that let you informed every subscriber that you get on your blog or any webapp</h1>
